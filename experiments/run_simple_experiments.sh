#!/bin/bash
# Run simplified experiments that focus on working mechanisms

cd /home/runner/work/cgal/cgal

echo "============================================================"
echo "Running Simplified CGAL Experiments"
echo "============================================================"
echo

# Create simple baseline test
cat > experiments/simple_baseline.py << 'PYEOF'
import numpy as np
import json
import sys
...
python experiments/simple_baseline.py
